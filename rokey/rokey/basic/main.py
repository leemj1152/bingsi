...
# shavel_pickup1 = posj(4.27, 13.58, 73.83, 0.35, 92.92, 1.41) posx(460.76, 42.18, 429.47, 134.14, 179.48, 131.16)
# shavel_pickup2 = posj(4.34, 15.77, 92.49, 0.35, 71.76, 1.4) posx(458.33, 42.61, 293.52, 98.35, 179.62, 95.43)

# cup_release1 = posj(5.98, 32.3, 62.07, 0.49, 86.56, 2.68) posx(579.57, 68.86, 332.84, 153.72, 178.91, 150.38)
# cup_release2 = posj(-8.62, 32.8, 61.88, 0.34, 86.31, -11.84) posx(580.86, -80.2, 328.82, 148.24, 178.91, 144.97)
    ...
    # shavel1 = posx(453, 60.88, 403.42, 116.97, 179.98, 116.95)
    # shavel2 = posx(453, 60.74, 282.8, 2.64, -179.73, 2.63)
    ...
    redbean3 = posj(-25.18, 18.43, 96.07, -14.83, 86.99, -110.92) #posx(278.2, -222.74, 305.29, 167.54, 176.91, 80.63)
